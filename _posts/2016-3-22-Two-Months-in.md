...
In the last month, we have not taken any flights but rather several long and cheap bus rides. We have been to six cities in two countries including [Baños]({% post_url 2016-3-7-Banos-Ecuador %}), [the monkey sanctuary in Puyo]({% post_url 2016-3-6-Los-Monos %}), and [Cuenca]({% post_url 2016-3-9-Cuenca-Ecuador %}) in Ecuador, plus [Máncora]({% post_url 2016-3-15-Mancora-Peru %}), [Trujillo]({% post_url 2016-3-22-Trujillo-Peru %}), and [Huaraz]({% post_url 2016-3-22-Huaraz-Peru %}) in Peru.

After two months on the road, here are some of our updated and new observations.

### Constants from [our first month’s items]({% post_url 2016-2-22-one-month-in %}):
...
- Favorite City: [Huaraz, Peru]({% post_url 2016-3-22-Huaraz-Peru %}) (beer, food, beautiful views - how can you go wrong?)